...
class ProductTourKeys {
  ...
  static final GlobalKey showCollection = GlobalKey(
    debugLabel: 'showCollection',
  );
  static final GlobalKey showItemsInCollection = GlobalKey(
    debugLabel: 'showItemsInCollection',
  );
  static final GlobalKey addNewCollection = GlobalKey(
    debugLabel: 'addNewCollection',
  );
  ...
  static final GlobalKey showEditAndSearch = GlobalKey(
    debugLabel: 'showEditAndSearch',
  );
  static final GlobalKey showSettings = GlobalKey(debugLabel: 'showSettings');
  static final GlobalKey showAppearanceSection = GlobalKey(
    debugLabel: 'showAppearanceSection',
  );
  static final GlobalKey showDataSection = GlobalKey(
    debugLabel: 'showDataSection',
  );
  static final GlobalKey showMoreSection = GlobalKey(
    debugLabel: 'showMoreSection',
  );
