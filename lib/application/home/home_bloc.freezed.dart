...
/// @nodoc
abstract class _$$OnGetAllEntryCardsImplCopyWith<$Res> {
  factory _$$OnGetAllEntryCardsImplCopyWith(_$OnGetAllEntryCardsImpl value,
          $Res Function(_$OnGetAllEntryCardsImpl) then) =
      __$$OnGetAllEntryCardsImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$OnGetAllEntryCardsImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$OnGetAllEntryCardsImpl>
    implements _$$OnGetAllEntryCardsImplCopyWith<$Res> {
  __$$OnGetAllEntryCardsImplCopyWithImpl(_$OnGetAllEntryCardsImpl _value,
      $Res Function(_$OnGetAllEntryCardsImpl) _then)
      : super(_value, _then);
}

/// @nodoc

class _$OnGetAllEntryCardsImpl implements OnGetAllEntryCards {
  const _$OnGetAllEntryCardsImpl();

  @override
  String toString() {
    return 'HomeEvent.onGetAllEntryCards()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$OnGetAllEntryCardsImpl);
  }
...
abstract class OnGetAllEntryCards implements HomeEvent {
  const factory OnGetAllEntryCards() = _$OnGetAllEntryCardsImpl;
}
...
class __$$OnGetEntryCardsImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$OnGetEntryCardsImpl>
...
class _$OnGetEntryCardsImpl implements OnGetEntryCards {
  ...
  @override
  String toString() {
    return 'HomeEvent.onGetEntryCards(tabId: $tabId)';
  }
...
abstract class OnGetEntryCards implements HomeEvent {
  const factory OnGetEntryCards(final int tabId) = _$OnGetEntryCardsImpl;
...
class __$$OnPressedAddEntryImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$OnPressedAddEntryImpl>
...
class __$$OnLongPressedDeleteEntryImplCopyWithImpl<$Res>
    extends _$HomeEventCopyWithImpl<$Res, _$OnLongPressedDeleteEntryImpl>
...
class _$OnLongPressedDeleteEntryImpl implements OnLongPressedDeleteEntry {
  ...
  @override
  String toString() {
    return 'HomeEvent.onLongPressedDeleteEntry(tabId: $tabId, entryId: $entryId)';
  }
...
abstract class OnLongPressedDeleteEntry implements HomeEvent {
  const factory OnLongPressedDeleteEntry(final int tabId, final int entryId) =
...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(tab: $tab, tabs: $tabs, entry: $entry, entryCards: $entryCards, isLoading: $isLoading, isDeleted: $isDeleted, isAdded: $isAdded, errorMessage: $errorMessage)';
  }
