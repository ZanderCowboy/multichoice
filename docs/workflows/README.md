...
- Uses a dedicated GitHub App (`VERSION_BOT_APP_ID` / `VERSION_BOT_APP_PRIVATE_KEY`) to commit version bumps to protected branches — see [Protected Branch and GitHub App setup](../protected-branch-and-github-app.md)
